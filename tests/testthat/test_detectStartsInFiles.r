...
stat3=read.xlsx(xlsxFile="C:/Users/capeltier/Desktop/DataAnalysis/Chistopher PTR/Caroline_Peltier/Statistique_3.xlsx")
...
test_that("detect with derivative", expect_true(round(median(abs(res_manual$dfres$diff_higherDerivative),na.rm=T),digits=2)==0.43))
